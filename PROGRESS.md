...
**Task 4 — `GET /api/v1/profile` beserta `social_links`**, memakai pola yang sama
persis dengan modul `experiences`. Lalu task 5 (frontend), lalu berhenti di
**checkpoint 1**.
